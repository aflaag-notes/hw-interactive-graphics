...
class MeshDrawer {
	constructor() {
            ...
            if (!gl.getShaderParameter(this.vertexShader, gl.COMPILE_STATUS)) {
                console.error("Vertex shader error:", gl.getShaderInfoLog(this.vertexShader));
            }
            ...
            if (!gl.getShaderParameter(this.fragmentShader, gl.COMPILE_STATUS)) {
                console.error("Fragment shader error:", gl.getShaderInfoLog(this.fragmentShader));
            }
            ...
            console.log("link status:", gl.getProgramParameter(this.program, gl.LINK_STATUS));
            console.log("aPosition index:", gl.getAttribLocation(this.program, "aPosition"));
            console.log("aTexCoord index:", gl.getAttribLocation(this.program, "aTexCoord"));
            console.log("vert shader log:", gl.getShaderInfoLog(this.vertexShader));
            console.log("frag shader log:", gl.getShaderInfoLog(this.fragmentShader));
            console.log("program log:", gl.getProgramInfoLog(this.program));
            // Attribute locations (must match your shader)
